...
* **`name` (اسم الشخصية)**: أترك الاسم المحدد من "البروفايل المعطى".
* **`age` (العمر التقديري)**:
    * حدث العمر أو الوصف الدال عليه إن وُجد في النص.
...
* **`physical_characteristics` (الصفات الجسدية)**:
    * حدث **جميع الصفات الجسدية** المذكورة صراحةً أو ضمنًا في النص.
    * قدم هذه الصفات كـ **قائمة (list) من السلاسل النصية**.
    * إذا لم تُذكر أي صفات جديدة، أترك القائمة كما هي في "البروفايل المعطى".
* **`personality` (الصفات النفسية)**:
    * حدث أو أضف **الصفات النفسية أو السلوكية** التي تظهر بوضوح في النص.
    * اكتب هذه الصفات كنص وصفي.
    * إذا لم تُذكر أي صفات جديدة، اترك القيمة كما هي في "البروفايل المعطى".
* **`events` (الأحداث)**:
    * حدث أو أضف إلى قائمة الأحداث **جميع الأحداث المحورية والمهمة** التي تؤثر على تطور الشخصية أو القصة.
    * تجاهل الأحداث التفصيلية أو العادية.
    * إذا لم تُذكر أي أحداث جديدة، اترك القائمة كما هي في "البروفايل المعطى".
* **`relations` (العلاقات)**:
...
* **`aliases` (الأسماء المستعارة)**:
    * حدث أو أضف أي **أسماء أو ألقاب أخرى** يُشار بها إلى الشخصية في النص.
    * قدم هذه الأسماء كـ **قائمة (list) من السلاسل النصية**.
    * إذا لم يُذكر أي اسم جديد، اترك القائمة كما هي في "البروفايل المعطى".
* **`id` (المُعرف)**: أترك المُعرف الفريد للشخصية كما هو في "البروفايل المعطى"؛ لا يتم تغييره.
