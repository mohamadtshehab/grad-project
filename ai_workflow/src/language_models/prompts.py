...
=======
2. الحقول القائمة (events, personality, aliases, physical_characteristics) أرجع العناصر الجديدة فقط، أو قائمة فارغة [] إذا لا يوجد جديد.
3. relations إلزامي دائمًا بصيغة محددة، أو [] إذا لا يوجد جديد.
4. شخصيات جديدة: أضفها كاملة بكل الحقول الممكنة.
5. شخصيات بدون تغييرات: تجاهلها.
6. إذا لم يكن هناك أي تغييرات أو إضافات: أرجع JSON فارغ [].
7. الحقل physical_characteristics يجب ألا يبقى فارغًا إذا ورد أي وصف جسدي مباشر أو ضمني في النص:
>>>>>>> cdbf19e699fca259958993c6df6f4865ecc42e96
